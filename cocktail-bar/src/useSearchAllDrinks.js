...
const searchAlcoholicDrinks = 'https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Alcoholic';
const searchNonAlcoholicDrinks = 'https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Non_Alcoholic'
